...
@section('content')
    <form action="{{ route('orders.index') }}">
        <div class="row">
            <div class="col-md-5">
                <input type="text" name="buyer_email" placeholder="Search by buyer email" class="form-control"
            ...
            <div class="col-md-2">
                <select name="status" id="status" class="form-control">
                    ...
                    <option {{ Request::get('status') == 'PROCESS' ? 'selected' : '' }} value="PROCESS">PROCES</option>
