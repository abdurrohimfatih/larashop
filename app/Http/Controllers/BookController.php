...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('save_action') == 'PUBLISH') {
            return redirect()->route('books.create')->with('success', 'Book successfully saved and published');
        } else {
            return redirect()->route('books.create')->with('success', 'Book saved as draft');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('books.edit', [$book->id])->with('success', 'Book successfully updated');
    }
    ...
    public function restore($id)
    {
        ...
        if ($book->trashed()) {
            $book->restore();
            return redirect()->route('books.trash')->with('success', 'Book successfully restored');
        } else {
